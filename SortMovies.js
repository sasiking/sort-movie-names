...
window.onload = function() {
    ...
    document.getElementById("number-submit").addEventListener("click",sort);
}
function sort(){
    ...
    let atr = document.getElementById('number-guess').value;
    let mov = sortMoviesByAttr(movies,atr);
    displayMovies(mov);
}
/**
